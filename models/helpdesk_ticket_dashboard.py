...
class TicketDashboard(models.Model):
    ...
    def get_ticket_dashboard_count(self):
        ...
        return self.env['ir.ui.view'].with_context()._render_template('advicts_advance_helpdesk.ticket_dashboard_count', {
            'data_dict': {},
        })
...
#                 if self.env.user.has_group('advicts_advance_helpdesk.helpdesk_group_team_leader') and self.env.user.has_group('advicts_advance_helpdesk.helpdesk_group_user') and not self.env.user.has_group('advicts_advance_helpdesk.helpdesk_group_manager'):
...
#                 elif not self.env.user.has_group('advicts_advance_helpdesk.helpdesk_group_team_leader') and self.env.user.has_group('advicts_advance_helpdesk.helpdesk_group_user') and not self.env.user.has_group('advicts_advance_helpdesk.helpdesk_group_manager'):
#                     team_ids = self.env['sh.helpdesk.team'].sudo().search(
...
#                 ticket_data_dic.update({search_stage.name: ticket_list})
#                 ticket_data_list.append(search_stage.name)
#         return self.env['ir.ui.view'].with_context()._render_template('advicts_advance_helpdesk.ticket_dashboard_tbl', {
#             'ticket_data_dic': ticket_data_dic,
#             'ticket_data_list': ticket_data_list,
#         })
