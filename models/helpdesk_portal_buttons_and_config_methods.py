...
class ShHelpdeskTicketButtonsAndConfig(models.Model):
    ...
    def action_approve(self):
        ...
        if self.stage_id.sh_next_stage_ids and self.ticket_type:
    ...
    def action_send_whatsapp(self):
        ...
        template = self.env.ref('advicts_advance_helpdesk.sh_send_whatsapp_email_template')
    ...
    def action_sh_helpdesk_ticket_merge(self):
        ...
        return {
            ...
            'view_id': self.env.ref('advicts_advance_helpdesk.sh_helpdesk_ticket_merge_ticket_wizard_form_view').id,
            'target': 'new',
            'type': 'ir.actions.act_window'
        }
    ...
    def _compute_form_url(self):
        ...
        if self:
            ...
            action = self.env.ref('advicts_advance_helpdesk.sh_helpdesk_ticket_action').id
    ...
    def action_mass_update_wizard(self):
        return {
            ...
            'view_id':self.env.ref('advicts_advance_helpdesk.sh_helpdesk_ticket_mass_update_wizard_form_view').id,
            'target':'new',
            'type':'ir.actions.act_window'
        }
